...
def main():
    ...
    frames = 0
    pygame.font.init()
    font = pygame.font.Font('/usr/share/fonts/truetype/ubuntu/UbuntuMono-B.ttf', 24)
    ...
    while playing:
        ...
        for c in clist:
            ...
            screen.blit(font.render(str(c[1])+", "+str(c[3]), False, (128, 128, 128)), c[0])
